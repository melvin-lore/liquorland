		            ...
		            <div class="col-md-12">
		            	<div class="form-group">
		                  ...
		                  <select name="" id="" class="form-control">
		                    ...
		                    <option value="">Lavington</option>
		                    <option value="">Kileleshwa</option>
		                    <option value="">Langata</option>
		                    <option value="">Umoja</option>
		                    <option value="">Other(Specify on Street Address) </option>
		                  </select>
		                </div>
		            	</div>
		            </div>
	          		...
	          		<div class="cart-detail p-3 p-md-4">
						...
						<i class="fa fa-cc-discover" style="color:orange;"></i>
									...
									<div class="form-group">
										<div class="col-md-12">
											<div class="radio">
											   <label><input type="radio" name="optradio" class="mr-2"> Swipe on Delivery(+1.8%)</label>
											</div>
										</div>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										<div class="col-md-12">
											<div class="radio">
											   <label><input type="radio" name="optradio" class="mr-2"> Mpesa(Buy Goods->Till number: 002233)</label>
											</div>
										</div>
									</div>
									<div class="form-group">
